...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    DEF_TIM(TIM16, CH1, PB8,  TIM_USE_LED,                 0,  10,  0 ), // LED Strip
    DEF_TIM(TIM17, CH1, PB9,  TIM_USE_TRANSPONDER,         0,  11,  0 ), // Transponder
    ...
    DEF_TIM(TIM4,  CH3, PD14, TIM_USE_CAMERA_CONTROL,      0,  12,  0 ),
};
