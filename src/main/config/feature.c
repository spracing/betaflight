...
#define FC_DEFAULT_FEATURES (FEATURE_DYNAMIC_FILTER | FEATURE_ANTI_GRAVITY | FEATURE_AIRMODE)
#define ALL_DEFAULT_FEATURES (DEFAULT_FEATURES | DEFAULT_RX_FEATURE | FC_DEFAULT_FEATURES)

PG_REGISTER_WITH_RESET_TEMPLATE(featureConfig_t, featureConfig, PG_FEATURE_CONFIG, 0);

PG_RESET_TEMPLATE(featureConfig_t, featureConfig,
    .enabledFeatures =  ALL_DEFAULT_FEATURES & ~(FC_DEFAULT_FEATURE_OVERRIDES),
);
